 ...
 * 
 * @RequiredArgsConstructor public class Oauth2AuthenticationSuccessHandler
 * implements AuthenticationSuccessHandler{
 * 
 * //private final PortfolioCommandService portfolioService; private final
 * RedirectStrategy redirectStrategy; private final
 ...
 * this.portfolioService.createNewPortfolio(authentication.getName()); if
 ...
 * //String email =
 * oToken.getPrincipal().getAttributes().get("email").toString(); } }
